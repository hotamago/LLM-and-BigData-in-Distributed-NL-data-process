...
def run_spark_flow_safe(record, dict_flowjson: dict, columns_info: list, worker_cfg: dict):
    """
    ...
    if data_processed is not None:
        ...
        try:
            ...
            for i in range(len(list_res)):
                ...
                list_res[i] = str(data_processed.get(column_name, "")).strip() if data_processed.get(column_name) else ""
